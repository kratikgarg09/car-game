...
# changing the logo
logo = pygame.image.load("D:\programming tutorial\Python Course with Notes\car game\logo.jpeg")
...
def introImg(x, y):
    intro = pygame.image.load("D:\programming tutorial\Python Course with Notes\car game\intro.png")

    screen.blit(intro, (x, y))


def instructionIMG(x, y):
    instruct = pygame.image.load("D:\\programming tutorial\\Python Course with Notes\\car game\\instruction.png")
    run = True
    while run:
...
def aboutIMG(x, y):
    aboutimg = pygame.image.load("D:\\programming tutorial\\Python Course with Notes\\car game\About.png")
    run = True
    while run:
...
def introscreen():
    run = True
    pygame.mixer.music.load("D:\programming tutorial\Python Course with Notes\car game\startingMusic.mp3")
    ...
    while run:
        ...
        #### if we click on the INSTRUCTION button ####
            if click:
                # DISPLAYING OUR INSTRUCTION IMAGE BY CALLING IT
                instructionIMG(0, 0)
...
def countdown():
    ...
    countdownBacground = pygame.image.load("D:\\programming tutorial\\Python Course with Notes\\car game\\bg.png")
...
def gameloop():
    ...
    ####### music #######
    pygame.mixer.music.load("D:\programming tutorial\Python Course with Notes\car game\BackgroundMusic.mp3")
    pygame.mixer.music.play()
    ###### sound effect for collision ######
    crash_sound = pygame.mixer.Sound("D:\\programming tutorial\\Python Course with Notes\\car game\\car_crash.wav")
    ...
    # highscore part
    with open("D:\\programming tutorial\\Python Course with Notes\\car game\\highscore.txt", "r") as f:
        highscore = f.read()
    ...
    bg = pygame.image.load("D:\\programming tutorial\\Python Course with Notes\\car game\\bg.png")

    # setting our player
    maincar = pygame.image.load("D:\programming tutorial\Python Course with Notes\car game\car.png")
    maincarX = 350
    maincarY = 495
    maincarX_change = 0
    maincarY_change = 0
    ...
    # other cars
    car1 = pygame.image.load("D:\\programming tutorial\\Python Course with Notes\\car game\\car1.jpeg")
    car1X = random.randint(178, 490)
    car1Y = 100
    car1Ychange = 10
    car2 = pygame.image.load("D:\\programming tutorial\\Python Course with Notes\\car game\\car2.png")
    car2X = random.randint(178, 490)
    car2Y = 100
    car2Ychange = 10

    car3 = pygame.image.load("D:\\programming tutorial\\Python Course with Notes\\car game\\car3.png")
    ...
    while run:
        ...
        with open("D:\programming tutorial\Python Course with Notes\car game\highscore.txt", "w") as f:
